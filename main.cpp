...
int main()
{
    ...
    if(choose==0)
    {
        ...
        FILE *fp = fopen("CM Sktech Various_k.csv", "w+"); //创建csv文件用于存储数据
    ...
    else if(choose==1)
    {
        ...
        FILE *fp = fopen("CM Sktech Various_memory_k.csv", "w+"); //创建csv文件用于存储数据
    ...
    else if(choose==2)
    {
        ...
        FILE *fp = fopen("CM Sktech Various_T.csv", "w+"); //创建csv文件用于存储数据
    ...
    else if(choose==3)
    {
        ...
        FILE *fp = fopen("CM Sktech Various_memory_T.csv", "w+"); //创建csv文件用于存储数据
